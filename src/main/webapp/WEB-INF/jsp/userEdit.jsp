...
<%--        <link href="../main.css" rel="stylesheet">--%>
    ...
    <body>
        ...
        <form action="MyController" method="post">
            <input type="hidden" name="command" value="UserSaveCommand">
...
<%--                </c:forEach>--%>
<%--            </select>--%>
<%--            <a class="save" href="MyController?command=UserSaveCommand&id=${user.id}">Сохранить</a>--%>
...
<%--            </c:if>--%>
            <a class="back" href="MyController?command=GoToLogination">Отменить</a>
        </form>
    </body>
</html>